# DQ Report: mvs_opendata — 2014-05

**Status:** PASS  
**Rows:** 100,938  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:56:18.137134

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 96008 | 2 | [0, 20000] |
| own_weight | range | info | 100892 | 531 | [40, 45000] |
| total_weight | range | info | 100930 | 99 | [60, 90000] |
| payload | range | info | 100891 | 56 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 9260 |
...
| dep_code | distinct_count | INFO | 259 |
| dep_name | distinct_count | INFO | 280 |
| brand | distinct_count | INFO | 742 |
| model | distinct_count | INFO | 3540 |
...
| capacity | distinct_count | INFO | 1410 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3278 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2268 |
| n_reg_new | distinct_count | INFO | 92954 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 3668 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 92913 |
