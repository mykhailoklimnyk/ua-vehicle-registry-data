# DQ Report: mvs_opendata — 2014-06

**Status:** PASS  
**Rows:** 125,930  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:56:37.811152

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 119664 | 1 | [0, 20000] |
| own_weight | range | info | 125917 | 598 | [40, 45000] |
| total_weight | range | info | 125927 | 110 | [60, 90000] |
| payload | range | info | 125916 | 79 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 10069 |
...
| dep_code | distinct_count | INFO | 266 |
| dep_name | distinct_count | INFO | 292 |
| brand | distinct_count | INFO | 805 |
| model | distinct_count | INFO | 3941 |
...
| capacity | distinct_count | INFO | 1515 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3668 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2473 |
| n_reg_new | distinct_count | INFO | 114908 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4210 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 114857 |
