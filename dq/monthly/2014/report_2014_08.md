# DQ Report: mvs_opendata — 2014-08

**Status:** PASS  
**Rows:** 123,295  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:56:41.606994

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 115890 | 1 | [0, 20000] |
| own_weight | range | info | 123289 | 592 | [40, 45000] |
| total_weight | range | info | 123294 | 89 | [60, 90000] |
| payload | range | info | 123289 | 54 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11038 |
...
| dep_code | distinct_count | INFO | 253 |
| dep_name | distinct_count | INFO | 284 |
| brand | distinct_count | INFO | 805 |
| model | distinct_count | INFO | 3837 |
...
| own_weight | distinct_count | INFO | 3448 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2430 |
| n_reg_new | distinct_count | INFO | 114062 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4013 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 114012 |
