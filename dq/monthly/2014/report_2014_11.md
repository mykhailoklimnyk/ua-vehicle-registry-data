# DQ Report: mvs_opendata — 2014-11

**Status:** PASS  
**Rows:** 120,757  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:56:19.454755

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 113813 | 1 | [0, 20000] |
| own_weight | range | info | 120753 | 669 | [40, 45000] |
| total_weight | range | info | 120757 | 87 | [60, 90000] |
| payload | range | info | 120753 | 75 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11059 |
...
| dep_code | distinct_count | INFO | 246 |
| dep_name | distinct_count | INFO | 277 |
| brand | distinct_count | INFO | 778 |
...
| capacity | distinct_count | INFO | 1476 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3578 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2446 |
| n_reg_new | distinct_count | INFO | 110586 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4120 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 110557 |
