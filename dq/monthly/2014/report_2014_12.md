# DQ Report: mvs_opendata — 2014-12

**Status:** PASS  
**Rows:** 135,501  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:56:25.152444

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 129508 | 4 | [0, 20000] |
| own_weight | range | info | 135500 | 822 | [40, 45000] |
| total_weight | range | info | 135501 | 61 | [60, 90000] |
| payload | range | info | 135500 | 70 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11574 |
...
| dep_code | distinct_count | INFO | 248 |
| dep_name | distinct_count | INFO | 276 |
| brand | distinct_count | INFO | 754 |
| model | distinct_count | INFO | 3509 |
...
| capacity | distinct_count | INFO | 1529 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3652 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2439 |
| n_reg_new | distinct_count | INFO | 119911 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4306 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 119885 |
