# DQ Report: mvs_opendata — 2014-07

**Status:** PASS  
**Rows:** 151,791  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:56:38.836024

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 144093 | 3 | [0, 20000] |
| own_weight | range | info | 151775 | 600 | [40, 45000] |
| total_weight | range | info | 151789 | 89 | [60, 90000] |
| payload | range | info | 151774 | 57 | [0, 35000] |
...
| dep_code | distinct_count | INFO | 278 |
| dep_name | distinct_count | INFO | 303 |
| brand | distinct_count | INFO | 867 |
| model | distinct_count | INFO | 4264 |
...
| capacity | distinct_count | INFO | 1638 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3767 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2602 |
| n_reg_new | distinct_count | INFO | 137924 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4392 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 137877 |
