# DQ Report: mvs_opendata — 2014-10

**Status:** PASS  
**Rows:** 129,891  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:56:13.248828

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 122612 | 1 | [0, 20000] |
| own_weight | range | info | 129889 | 602 | [40, 45000] |
| total_weight | range | info | 129891 | 87 | [60, 90000] |
| payload | range | info | 129889 | 62 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11234 |
...
| dep_code | distinct_count | INFO | 244 |
| dep_name | distinct_count | INFO | 276 |
| brand | distinct_count | INFO | 787 |
| model | distinct_count | INFO | 3733 |
...
| capacity | distinct_count | INFO | 1520 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3654 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2483 |
| n_reg_new | distinct_count | INFO | 118707 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4233 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 118666 |
