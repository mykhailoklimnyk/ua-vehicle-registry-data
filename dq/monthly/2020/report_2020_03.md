# DQ Report: mvs_opendata — 2020-03

**Status:** PASS  
**Rows:** 91,935  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:02:51.381793

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 87609 | 1 | [0, 20000] |
| own_weight | range | info | 91867 | 41 | [40, 45000] |
| total_weight | range | info | 91929 | 12 | [60, 90000] |
| payload | range | info | 91864 | 87 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 10849 |
...
| brand | distinct_count | INFO | 693 |
| model | distinct_count | INFO | 3417 |
...
| own_weight | distinct_count | INFO | 3981 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2263 |
| n_reg_new | distinct_count | INFO | 89591 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4354 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 89527 |
