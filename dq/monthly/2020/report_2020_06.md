# DQ Report: mvs_opendata — 2020-06

**Status:** PASS  
**Rows:** 165,462  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:03:36.287334

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 157124 | 2 | [0, 20000] |
| own_weight | range | info | 165327 | 96 | [40, 45000] |
| total_weight | range | info | 165450 | 19 | [60, 90000] |
| payload | range | info | 165324 | 155 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11470 |
...
| brand | distinct_count | INFO | 850 |
| model | distinct_count | INFO | 4569 |
...
| capacity | distinct_count | INFO | 1586 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 4764 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2764 |
| n_reg_new | distinct_count | INFO | 162026 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5551 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 161922 |
