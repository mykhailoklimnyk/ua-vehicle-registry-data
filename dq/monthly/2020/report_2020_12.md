# DQ Report: mvs_opendata — 2020-12

**Status:** PASS  
**Rows:** 178,795  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:04:44.842719

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 171377 | 6 | [0, 20000] |
| own_weight | range | info | 178719 | 102 | [40, 45000] |
| total_weight | range | info | 178768 | 19 | [60, 90000] |
| payload | range | info | 178707 | 155 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 12787 |
...
| brand | distinct_count | INFO | 849 |
| model | distinct_count | INFO | 4337 |
...
| own_weight | distinct_count | INFO | 4814 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2731 |
| n_reg_new | distinct_count | INFO | 174163 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5484 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 174129 |
