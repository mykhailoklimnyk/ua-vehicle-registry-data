# DQ Report: mvs_opendata — 2020-01

**Status:** PASS  
**Rows:** 183,002  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:03:00.412645

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 175431 | 2 | [0, 20000] |
| own_weight | range | info | 182933 | 52 | [40, 45000] |
| total_weight | range | info | 183000 | 11 | [60, 90000] |
| payload | range | info | 182932 | 141 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 14294 |
...
| brand | distinct_count | INFO | 840 |
| model | distinct_count | INFO | 4082 |
...
| capacity | distinct_count | INFO | 1481 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 4643 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2614 |
| n_reg_new | distinct_count | INFO | 169182 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5440 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 168965 |
