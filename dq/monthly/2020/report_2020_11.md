# DQ Report: mvs_opendata — 2020-11

**Status:** PASS  
**Rows:** 165,535  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:04:51.178560

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 157989 | 4 | [0, 20000] |
| own_weight | range | info | 165448 | 94 | [40, 45000] |
| total_weight | range | info | 165504 | 16 | [60, 90000] |
| payload | range | info | 165437 | 133 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11889 |
...
| model | distinct_count | INFO | 4157 |
...
| own_weight | distinct_count | INFO | 4650 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2604 |
| n_reg_new | distinct_count | INFO | 161600 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5325 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 150247 |
