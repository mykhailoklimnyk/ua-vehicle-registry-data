# DQ Report: mvs_opendata — 2020-05

**Status:** PASS  
**Rows:** 127,734  
**Checks:** 13/16 passed, 3 failed  
**Timestamp:** 2026-03-19T14:03:54.376264

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| own_weight | range | info | 127660 | 68 | [40, 45000] |
| total_weight | range | info | 127729 | 9 | [60, 90000] |
| payload | range | info | 127658 | 144 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 9633 |
| oper_code | distinct_count | INFO | 71 |
| oper_name | distinct_count | INFO | 71 |
...
| brand | distinct_count | INFO | 765 |
| model | distinct_count | INFO | 3896 |
...
| capacity | distinct_count | INFO | 1411 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 4498 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2515 |
| n_reg_new | distinct_count | INFO | 125257 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5095 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 125199 |
