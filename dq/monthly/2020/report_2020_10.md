# DQ Report: mvs_opendata — 2020-10

**Status:** PASS  
**Rows:** 184,013  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:04:08.737568

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 175275 | 1 | [0, 20000] |
| own_weight | range | info | 183863 | 110 | [40, 45000] |
| total_weight | range | info | 184000 | 14 | [60, 90000] |
| payload | range | info | 183858 | 122 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 12555 |
...
| model | distinct_count | INFO | 4515 |
...
| own_weight | distinct_count | INFO | 5026 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2781 |
| n_reg_new | distinct_count | INFO | 179701 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5954 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 179690 |
