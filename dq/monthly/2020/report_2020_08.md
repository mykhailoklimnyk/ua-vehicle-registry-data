# DQ Report: mvs_opendata — 2020-08

**Status:** PASS  
**Rows:** 164,030  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:03:53.964507

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 155966 | 3 | [0, 20000] |
| own_weight | range | info | 163892 | 106 | [40, 45000] |
| total_weight | range | info | 164009 | 13 | [60, 90000] |
| payload | range | info | 163883 | 121 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11760 |
...
| model | distinct_count | INFO | 4526 |
...
| own_weight | distinct_count | INFO | 4809 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2727 |
| n_reg_new | distinct_count | INFO | 159128 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5542 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 158713 |
