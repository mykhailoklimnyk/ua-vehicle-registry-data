# DQ Report: mvs_opendata — 2016-01

**Status:** PASS  
**Rows:** 76,162  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:57:28.143272

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 71895 | 1 | [0, 20000] |
| own_weight | range | info | 76157 | 247 | [40, 45000] |
| total_weight | range | info | 76162 | 35 | [60, 90000] |
| payload | range | info | 76157 | 53 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 9376 |
| oper_code | distinct_count | INFO | 70 |
...
| dep_name | distinct_count | INFO | 167 |
| brand | distinct_count | INFO | 639 |
| model | distinct_count | INFO | 2867 |
...
| capacity | distinct_count | INFO | 1281 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3321 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2018 |
| n_reg_new | distinct_count | INFO | 71953 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 3774 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 71944 |
