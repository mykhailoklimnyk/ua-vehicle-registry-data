# DQ Report: mvs_opendata — 2016-11

**Status:** PASS  
**Rows:** 126,706  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:58:58.560628

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 118750 | 5 | [0, 20000] |
| own_weight | range | info | 126695 | 161 | [40, 45000] |
| total_weight | range | info | 126705 | 41 | [60, 90000] |
| payload | range | info | 126695 | 82 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 12582 |
...
| brand | distinct_count | INFO | 789 |
| model | distinct_count | INFO | 3787 |
...
| own_weight | distinct_count | INFO | 3966 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2523 |
| n_reg_new | distinct_count | INFO | 120865 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4655 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 120848 |
