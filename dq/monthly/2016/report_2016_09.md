# DQ Report: mvs_opendata — 2016-09

**Status:** PASS  
**Rows:** 126,722  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:58:55.175147

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 118745 | 2 | [0, 20000] |
| own_weight | range | info | 126714 | 183 | [40, 45000] |
| total_weight | range | info | 126721 | 25 | [60, 90000] |
| payload | range | info | 126714 | 94 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 12032 |
...
| model | distinct_count | INFO | 4070 |
...
| own_weight | distinct_count | INFO | 4023 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2572 |
| n_reg_new | distinct_count | INFO | 120277 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4601 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 120255 |
