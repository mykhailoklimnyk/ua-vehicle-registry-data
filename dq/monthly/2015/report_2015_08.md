# DQ Report: mvs_opendata — 2015-08

**Status:** PASS  
**Rows:** 95,978  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:57:13.185995

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 91151 | 3 | [0, 20000] |
| own_weight | range | info | 95973 | 346 | [40, 45000] |
| total_weight | range | info | 95978 | 38 | [60, 90000] |
| payload | range | info | 95973 | 63 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 9765 |
...
| dep_code | distinct_count | INFO | 222 |
| dep_name | distinct_count | INFO | 253 |
| brand | distinct_count | INFO | 739 |
| model | distinct_count | INFO | 3479 |
...
| capacity | distinct_count | INFO | 1425 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3485 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2293 |
| n_reg_new | distinct_count | INFO | 90349 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 3932 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 90309 |
