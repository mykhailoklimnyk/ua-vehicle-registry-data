# DQ Report: mvs_opendata — 2015-02

**Status:** PASS  
**Rows:** 97,969  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:56:31.710546

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 92203 | 3 | [0, 20000] |
| own_weight | range | info | 97963 | 436 | [40, 45000] |
| total_weight | range | info | 97969 | 51 | [60, 90000] |
| payload | range | info | 97963 | 62 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 9831 |
...
| dep_name | distinct_count | INFO | 273 |
| brand | distinct_count | INFO | 718 |
| model | distinct_count | INFO | 3271 |
...
| capacity | distinct_count | INFO | 1399 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3468 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2297 |
| n_reg_new | distinct_count | INFO | 90735 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 3905 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 90705 |
