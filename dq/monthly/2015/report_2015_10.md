# DQ Report: mvs_opendata — 2015-10

**Status:** PASS  
**Rows:** 136,273  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:57:34.533159

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 128837 | 7 | [0, 20000] |
| own_weight | range | info | 136262 | 497 | [40, 45000] |
| total_weight | range | info | 136272 | 64 | [60, 90000] |
| payload | range | info | 136262 | 71 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 12027 |
...
| dep_code | distinct_count | INFO | 236 |
| dep_name | distinct_count | INFO | 237 |
| brand | distinct_count | INFO | 813 |
| model | distinct_count | INFO | 3978 |
...
| capacity | distinct_count | INFO | 1607 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3844 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2601 |
| n_reg_new | distinct_count | INFO | 128575 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4496 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 128531 |
