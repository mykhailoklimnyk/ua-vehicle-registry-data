# DQ Report: mvs_opendata — 2015-03

**Status:** PASS  
**Rows:** 101,436  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:57:15.061047

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 95831 | 1 | [0, 20000] |
| own_weight | range | info | 101433 | 544 | [40, 45000] |
| total_weight | range | info | 101436 | 44 | [60, 90000] |
| payload | range | info | 101433 | 65 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 10031 |
...
| model | distinct_count | INFO | 3553 |
...
| capacity | distinct_count | INFO | 1433 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3485 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2362 |
| n_reg_new | distinct_count | INFO | 95969 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 3861 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 95919 |
