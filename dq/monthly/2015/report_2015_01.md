# DQ Report: mvs_opendata — 2015-01

**Status:** PASS  
**Rows:** 81,118  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:56:12.016647

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 76340 | 1 | [0, 20000] |
| own_weight | range | info | 81118 | 486 | [40, 45000] |
| total_weight | range | info | 81118 | 33 | [60, 90000] |
| payload | range | info | 81118 | 51 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 9177 |
...
| dep_code | distinct_count | INFO | 239 |
| dep_name | distinct_count | INFO | 264 |
| brand | distinct_count | INFO | 679 |
| model | distinct_count | INFO | 3016 |
...
| capacity | distinct_count | INFO | 1332 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3300 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2150 |
| n_reg_new | distinct_count | INFO | 76107 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 3826 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 76083 |
