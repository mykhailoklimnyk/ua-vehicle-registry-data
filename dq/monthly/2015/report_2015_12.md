# DQ Report: mvs_opendata — 2015-12

**Status:** PASS  
**Rows:** 118,284  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:58:23.984025

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 110726 | 3 | [0, 20000] |
| own_weight | range | info | 118261 | 446 | [40, 45000] |
| total_weight | range | info | 118283 | 55 | [60, 90000] |
| payload | range | info | 118260 | 77 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11559 |
...
| dep_name | distinct_count | INFO | 174 |
| brand | distinct_count | INFO | 797 |
| model | distinct_count | INFO | 3661 |
...
| capacity | distinct_count | INFO | 1518 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3805 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2468 |
| n_reg_new | distinct_count | INFO | 110499 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4553 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 110488 |
