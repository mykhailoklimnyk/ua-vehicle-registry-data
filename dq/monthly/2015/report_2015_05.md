# DQ Report: mvs_opendata — 2015-05

**Status:** PASS  
**Rows:** 104,631  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:56:44.758865

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 97522 | 3 | [0, 20000] |
| own_weight | range | info | 104628 | 423 | [40, 45000] |
| total_weight | range | info | 104631 | 46 | [60, 90000] |
| payload | range | info | 104628 | 42 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 10014 |
...
| dep_code | distinct_count | INFO | 232 |
| dep_name | distinct_count | INFO | 260 |
| brand | distinct_count | INFO | 810 |
| model | distinct_count | INFO | 3907 |
...
| capacity | distinct_count | INFO | 1499 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 3546 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2408 |
| n_reg_new | distinct_count | INFO | 98862 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 3989 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 98819 |
