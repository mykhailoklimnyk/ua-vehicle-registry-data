# DQ Report: mvs_opendata — 2018-11

**Status:** PASS  
**Rows:** 131,433  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:01:16.152426

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 123689 | 1 | [0, 20000] |
| own_weight | range | info | 131354 | 58 | [40, 45000] |
| total_weight | range | info | 131424 | 14 | [60, 90000] |
| payload | range | info | 131354 | 113 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 13453 |
...
| model | distinct_count | INFO | 4023 |
...
| own_weight | distinct_count | INFO | 4355 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2523 |
| n_reg_new | distinct_count | INFO | 124053 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5012 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 124044 |
