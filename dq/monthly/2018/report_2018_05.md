# DQ Report: mvs_opendata — 2018-05

**Status:** PASS  
**Rows:** 139,129  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:01:54.221047

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 130409 | 1 | [0, 20000] |
| own_weight | range | info | 139049 | 84 | [40, 45000] |
| total_weight | range | info | 139118 | 29 | [60, 90000] |
| payload | range | info | 139045 | 94 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 12648 |
...
| model | distinct_count | INFO | 4713 |
...
| capacity | distinct_count | INFO | 1524 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 4427 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2683 |
| n_reg_new | distinct_count | INFO | 131767 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5191 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 131751 |
