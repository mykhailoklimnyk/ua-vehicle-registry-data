# DQ Report: mvs_opendata — 2013-06

**Status:** PASS  
**Rows:** 170,487  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-18T19:26:49.099117

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 162709 | 8 | [0, 20000] |
| own_weight | range | info | 164720 | 31 | [40, 45000] |
| total_weight | range | info | 169460 | 5 | [60, 90000] |
| payload | range | info | 164579 | 80 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11715 |
...
| dep_name | distinct_count | INFO | 361 |
| brand | distinct_count | INFO | 887 |
| model | distinct_count | INFO | 4238 |
...
| own_weight | distinct_count | INFO | 3874 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2753 |
| n_reg_new | distinct_count | INFO | 160684 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4581 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 160565 |
