# DQ Report: mvs_opendata — 2013-08

**Status:** PASS  
**Rows:** 242,830  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T12:53:48.592799

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 234551 | 5 | [0, 20000] |
| own_weight | range | info | 233971 | 34 | [40, 45000] |
| total_weight | range | info | 241426 | 5 | [60, 90000] |
| payload | range | info | 233733 | 106 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 13799 |
...
| dep_code | distinct_count | INFO | 314 |
| dep_name | distinct_count | INFO | 366 |
| brand | distinct_count | INFO | 904 |
| model | distinct_count | INFO | 4434 |
...
| capacity | distinct_count | INFO | 1758 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 4158 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2969 |
| n_reg_new | distinct_count | INFO | 223937 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4978 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 223845 |
