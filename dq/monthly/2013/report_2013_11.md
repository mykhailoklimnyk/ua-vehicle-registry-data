# DQ Report: mvs_opendata — 2013-11

**Status:** PASS  
**Rows:** 147,155  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-18T19:26:40.398113

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 140382 | 3 | [0, 20000] |
| own_weight | range | info | 142415 | 10 | [40, 45000] |
| total_weight | range | info | 146574 | 3 | [60, 90000] |
| payload | range | info | 142342 | 81 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11599 |
...
| dep_code | distinct_count | INFO | 290 |
| dep_name | distinct_count | INFO | 322 |
| brand | distinct_count | INFO | 829 |
...
| own_weight | distinct_count | INFO | 3718 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2566 |
| n_reg_new | distinct_count | INFO | 141254 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4371 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 141181 |
