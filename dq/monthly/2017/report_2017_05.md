# DQ Report: mvs_opendata — 2017-05

**Status:** PASS  
**Rows:** 119,208  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:59:41.758718

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 111353 | 1 | [0, 20000] |
| own_weight | range | info | 119198 | 101 | [40, 45000] |
| total_weight | range | info | 119206 | 15 | [60, 90000] |
| payload | range | info | 119197 | 108 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11531 |
...
| brand | distinct_count | INFO | 847 |
| model | distinct_count | INFO | 4250 |
...
| own_weight | distinct_count | INFO | 4140 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2493 |
| n_reg_new | distinct_count | INFO | 113974 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4867 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 113961 |
