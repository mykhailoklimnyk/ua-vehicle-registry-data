# DQ Report: mvs_opendata — 2017-04

**Status:** PASS  
**Rows:** 115,964  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:58:41.766503

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 107868 | 2 | [0, 20000] |
| own_weight | range | info | 115948 | 101 | [40, 45000] |
| total_weight | range | info | 115960 | 22 | [60, 90000] |
| payload | range | info | 115946 | 96 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11399 |
...
| dep_name | distinct_count | INFO | 169 |
| brand | distinct_count | INFO | 850 |
| model | distinct_count | INFO | 4222 |
...
| capacity | distinct_count | INFO | 1500 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 4105 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2535 |
| n_reg_new | distinct_count | INFO | 110391 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4789 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 110375 |
