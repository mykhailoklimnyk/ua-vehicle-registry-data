# DQ Report: mvs_opendata — 2017-06

**Status:** PASS  
**Rows:** 120,353  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T13:59:39.057628

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 112137 | 1 | [0, 20000] |
| own_weight | range | info | 120344 | 106 | [40, 45000] |
| total_weight | range | info | 120351 | 17 | [60, 90000] |
| payload | range | info | 120344 | 76 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 11431 |
...
| brand | distinct_count | INFO | 858 |
| model | distinct_count | INFO | 4333 |
...
| own_weight | distinct_count | INFO | 4098 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2511 |
| n_reg_new | distinct_count | INFO | 114939 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 4781 |
| secondary_fuel | distinct_count | INFO | 2 |
| n_reg_latin | distinct_count | INFO | 114921 |
