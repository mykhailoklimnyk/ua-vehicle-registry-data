# DQ Report: mvs_opendata — 2019-06

**Status:** PASS  
**Rows:** 165,788  
**Checks:** 13/16 passed, 3 failed  
**Timestamp:** 2026-03-19T14:02:10.546842

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| own_weight | range | info | 165648 | 63 | [40, 45000] |
| total_weight | range | info | 165786 | 9 | [60, 90000] |
| payload | range | info | 165648 | 122 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 13122 |
...
| own_weight | distinct_count | INFO | 4496 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2630 |
| n_reg_new | distinct_count | INFO | 151102 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5235 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 151097 |
