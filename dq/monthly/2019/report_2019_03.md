# DQ Report: mvs_opendata — 2019-03

**Status:** PASS  
**Rows:** 225,014  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:01:47.124083

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 215274 | 3 | [0, 20000] |
| own_weight | range | info | 224912 | 74 | [40, 45000] |
| total_weight | range | info | 225010 | 18 | [60, 90000] |
| payload | range | info | 224911 | 135 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 15047 |
...
| model | distinct_count | INFO | 4714 |
...
| own_weight | distinct_count | INFO | 4833 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2764 |
| n_reg_new | distinct_count | INFO | 205391 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5739 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 205374 |
