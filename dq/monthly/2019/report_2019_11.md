# DQ Report: mvs_opendata — 2019-11

**Status:** PASS  
**Rows:** 177,364  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:03:53.874314

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 169517 | 2 | [0, 20000] |
| own_weight | range | info | 177267 | 44 | [40, 45000] |
| total_weight | range | info | 177358 | 4 | [60, 90000] |
| payload | range | info | 177267 | 133 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 15211 |
| oper_code | distinct_count | INFO | 73 |
| oper_name | distinct_count | INFO | 73 |
...
| brand | distinct_count | INFO | 864 |
| model | distinct_count | INFO | 4288 |
...
| total_weight | distinct_count | INFO | 2754 |
| n_reg_new | distinct_count | INFO | 170590 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5497 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 170491 |
