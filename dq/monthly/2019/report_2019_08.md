# DQ Report: mvs_opendata — 2019-08

**Status:** PASS  
**Rows:** 194,933  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:03:06.447528

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 185759 | 2 | [0, 20000] |
| own_weight | range | info | 194748 | 40 | [40, 45000] |
| total_weight | range | info | 194930 | 10 | [60, 90000] |
| payload | range | info | 194748 | 134 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 14701 |
...
| brand | distinct_count | INFO | 928 |
| model | distinct_count | INFO | 4606 |
...
| capacity | distinct_count | INFO | 1611 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 4773 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2748 |
| n_reg_new | distinct_count | INFO | 176066 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5615 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 176056 |
