# DQ Report: mvs_opendata — 2019-12

**Status:** PASS  
**Rows:** 170,127  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:03:02.609417

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 163472 | 1 | [0, 20000] |
| own_weight | range | info | 170052 | 43 | [40, 45000] |
| total_weight | range | info | 170122 | 11 | [60, 90000] |
| payload | range | info | 170051 | 159 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 14857 |
...
| brand | distinct_count | INFO | 846 |
| model | distinct_count | INFO | 4149 |
...
| own_weight | distinct_count | INFO | 4716 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2709 |
| n_reg_new | distinct_count | INFO | 163333 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5435 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 163121 |
