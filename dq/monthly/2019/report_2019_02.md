# DQ Report: mvs_opendata — 2019-02

**Status:** PASS  
**Rows:** 233,615  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:02:24.930134

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 226759 | 7 | [0, 20000] |
| own_weight | range | info | 233541 | 79 | [40, 45000] |
| total_weight | range | info | 233605 | 19 | [60, 90000] |
| payload | range | info | 233540 | 115 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 15514 |
| oper_code | distinct_count | INFO | 75 |
| oper_name | distinct_count | INFO | 108 |
...
| brand | distinct_count | INFO | 796 |
| model | distinct_count | INFO | 3921 |
...
| capacity | distinct_count | INFO | 1565 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 4451 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2597 |
| n_reg_new | distinct_count | INFO | 217342 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5123 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 217332 |
