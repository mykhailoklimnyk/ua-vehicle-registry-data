# DQ Report: mvs_opendata — 2019-07

**Status:** PASS  
**Rows:** 197,998  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:02:23.430581

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 188414 | 5 | [0, 20000] |
| own_weight | range | info | 197800 | 69 | [40, 45000] |
| total_weight | range | info | 197988 | 11 | [60, 90000] |
| payload | range | info | 197799 | 136 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 14353 |
| oper_code | distinct_count | INFO | 80 |
| oper_name | distinct_count | INFO | 110 |
...
| brand | distinct_count | INFO | 907 |
| model | distinct_count | INFO | 4820 |
...
| capacity | distinct_count | INFO | 1702 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 4758 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2791 |
| n_reg_new | distinct_count | INFO | 178949 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5596 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 178939 |
