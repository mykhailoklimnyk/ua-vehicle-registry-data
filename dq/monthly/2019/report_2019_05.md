# DQ Report: mvs_opendata — 2019-05

**Status:** PASS  
**Rows:** 197,413  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:03:42.721667

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 188000 | 2 | [0, 20000] |
| own_weight | range | info | 197220 | 90 | [40, 45000] |
| total_weight | range | info | 197400 | 24 | [60, 90000] |
| payload | range | info | 197214 | 140 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 14136 |
| oper_code | distinct_count | INFO | 75 |
| oper_name | distinct_count | INFO | 102 |
...
| brand | distinct_count | INFO | 956 |
| model | distinct_count | INFO | 4846 |
...
| capacity | distinct_count | INFO | 1634 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 4787 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2842 |
| n_reg_new | distinct_count | INFO | 179336 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5641 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 179323 |
