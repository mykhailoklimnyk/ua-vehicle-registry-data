# DQ Report: mvs_opendata — 2019-04

**Status:** PASS  
**Rows:** 183,643  
**Checks:** 12/16 passed, 4 failed  
**Timestamp:** 2026-03-19T14:02:41.138679

## Failed Checks

| Field | Check | Severity | Total | Failed | Detail |
|-------|-------|----------|------:|-------:|--------|
| capacity | range | info | 174505 | 3 | [0, 20000] |
| own_weight | range | info | 183490 | 66 | [40, 45000] |
| total_weight | range | info | 183634 | 21 | [60, 90000] |
| payload | range | info | 183489 | 133 | [0, 35000] |
...
| reg_addr_koatuu | distinct_count | INFO | 13798 |
...
| model | distinct_count | INFO | 4727 |
...
| capacity | distinct_count | INFO | 1605 |
| own_weight | range | FAIL | [40, 45000] |
| own_weight | distinct_count | INFO | 4654 |
| total_weight | range | FAIL | [60, 90000] |
| total_weight | distinct_count | INFO | 2768 |
| n_reg_new | distinct_count | INFO | 165932 |
| payload | range | FAIL | [0, 35000] |
| payload | distinct_count | INFO | 5461 |
| secondary_fuel | distinct_count | INFO | 3 |
| n_reg_latin | distinct_count | INFO | 165916 |
